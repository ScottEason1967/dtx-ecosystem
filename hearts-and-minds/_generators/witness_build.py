...
HT_PERSONA = {p: "HomeTest Operating Model - Persona %s.html" % p.capitalize() for p in
              ["sarah","priya","aisha","adam","catherine","joe","anita","hannah","ngozi"]}
...
ht = JS_TEMPLATE.replace("@@IMG@@", "Assets/Personas/").replace("@@PERSONA@@", json.dumps(HT_PERSONA)).replace("@@DATA@@", data_json)
